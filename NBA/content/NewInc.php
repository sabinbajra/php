...
<?
		...
		echo "<form action=\"main.php?AdminPageID=NewIncome&Opt=NewIncome_Enf&Action=NEW\" method=\"post\" onSubmit=\" return form_Validator(this)\">"
		."<table width=\"510\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\" class=\"table\" align=\"center\">"
			."  <tr>" 
			."	  <td class=\"title\">New Income Heading<hr size =\"1\" color=\"#c1cdd8\"></td>"
			."	</tr>"
			."	<tr>"
			."	  <td>"
