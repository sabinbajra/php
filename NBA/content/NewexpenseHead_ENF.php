...
<?
	...
	{
					$query = "Insert into tbl_exphead (heading,description) values ('$_POST[heading]', '$_POST[description]')";
				...
				echo "<center><table width=\"60%\"  border=\"0\" cellpadding=\"3\" cellspacing=\"0\" bgcolor=\"#F4F4F4\" class=\"table\" align=\"center\">
						   <tr bgcolor=\"#FFFFFF\">
							<td  class=\"text\">Confirmation:<hr size =\"1\" color=\"#c1cdd8\"><div align=\"center\">Your New Heading has been added successfully...
							</div></td>
						  </tr>";
						  ?>
						  <tr>
