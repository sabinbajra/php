...
<form action="?AdminPageID=ViewExpenses&ViewExp=byDateView" method="POST" enctype="multipart/form-data" onSubmit=" return form_Validator(this)">
		  <table width="750" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
			<tr>
			<td colspan="2" class="title">View Expenditure Entry
	Datewise		  
...
<form action="?AdminPageID=ViewExpenses&ViewExp=byHeadingView" method="POST" enctype="multipart/form-data" onSubmit=" return form_Validator(this)">
		  <table width="750" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
			<tr>
			<td colspan="2" class="title">View Expenditure Headingwise
			  <hr size ="1" color="#c1cdd8"></td>
			</tr>
			<tr > 
...
<form action="?AdminPageID=ViewExpenses&ViewExp=byMemberView" method="POST" enctype="multipart/form-data" onSubmit=" return form_Validator(this)">
		  <table width="750" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
			<tr>
			<td colspan="2" class="title">View Expenditure Firmwise/Memberwise 
			  <hr size ="1" color="#c1cdd8"></td>
			</tr>
			<tr > 
