...
<br>
<center>
  <form name="news_articles_form" method="post" action="?MemberPageID=ArticleENF&Db=POST">
    ...
    <table border="0" cellspacing="1" cellpadding="2" id="uploadtable">
      <tr>
        ...
        <td width="256"><input name="headlines" type="text" class="text_box" size="65"></td>
      </tr>
      <tr>
        <td valign="top" class="text"><strong>News/Articles</strong></td>
        <td><strong>
          <textarea name="contents" cols="64" rows="10" class="text_box" id="contents"></textarea>
        </strong></td>
      </tr>
      <tr>
