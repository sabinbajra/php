<div class="TabbedPanelsContent">
	<?
		...
		//Display New books. 
		$bknewquery = "SELECT * FROM tbl_lib_book where grade='11' ORDER BY bk_id DESC LIMIT 5";
		...
		<table width="495" border="0" align="center" cellpadding="1" cellspacing="0">
          <tr class="text"> 
          	...
          	<td width="229" background="../manage/images/bks/button1_fill.gif"><strong>Name</strong></td>
          	<td width="140" background="../manage/images/bks/button1_fill.gif"><strong>Author</strong></td>
