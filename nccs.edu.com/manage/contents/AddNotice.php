    ...
    <td><center>
        <form name="news_articles_form" method="post" action="?AdminPageID=Contents&Added=Add_enf&Db=<?=$AddDB;?>">
          <table border="0" cellspacing="1" cellpadding="2" id="uploadtable">
            ...
            <tr> 
              <td valign="top" class="text"><strong>Notice</strong></td>
              <td><strong> 
            ...
            <tr>
			  ...
			  <input type="button" name="Submit" value="List Notice" onClick="window.location='?AdminPageID=Contents&List=ListingDB&ViewDB=Notice'" class="search_box1">
			  </td>
            </tr>
          </table>
          </form>
