...
<?
	...
	$query = "SELECT * FROM tbl_members, tbl_students WHERE auth_user = 'Student' AND tbl_members.id=tbl_students.id order by semester ASC LIMIT " . $start . ", 50";
        ...
        <table width="765" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr> 
            <td><table width="751" border="0" align="center" cellpadding="3" cellspacing="0" class="table">
                <tr> 
                  <td width="372"><? echo "<span class=\"title\"><strong>Total Student(s) : $count</strong></span>";?> 
                  </td>
              ...
              <?
			  	if ($New == "RegStd" || $New == "RegStdProfile" || $New == "RegisterENF" || $New == "ModStdProfile") {
					...
					if ($count == 0) {
						echo "&nbsp;&nbsp;<span class=\"title\"><strong>::</strong> No Student has been added yet...</span>";
					}
					else {
            ...
            <td> 
              <table width="750" border="0" align="center" cellpadding="2" cellspacing="0" class="table">
                <tr class="text"> 
                  ...
                  <td width="79" height="25" bgcolor="#ECECEC"><div align="center"><strong>Batch</strong></div></td>
                  <td width="79" bgcolor="#ECECEC"><strong>Semester</strong></td>
                  <td width="230" bgcolor="#ECECEC"><strong>Last Login</strong></td>
                ...
                <tr  <? echo "bgcolor=$color";?> class="EE"> 
                  ...
                  <td><div align="center"><?=$show[year_batch];?></div></td>
                  <td><?=$show[semester];?></td>
                  <td>
				  <?
				  ...
				  <?
					echo "<a href=\"?AdminPageID=Students&View=StdProfile&id=$show[id]\"><img src=\"../images/icons/ico_detail.gif\" border=\"0\" align=\"middle\" alt=\"View Profile of $show[firstname] $show[middlename] $show[lastname]\"></a>";
				  ?>
                  </div></td>
                  <td width="19">
				  <?
					if ($_SESSION["valid_user"] == "admin") {
						echo "<center><a href=\"?AdminPageID=Students&New=ModStdProfile&id=".$show[id]."\"><img src='../images/icons/ico_edit.gif' border='0' title=\"Edit Profile of $show[firstname] $show[middlename] $show[lastname]\"></a></center>";
					}
					else {
                  ...
                  <?
				  	if ($_SESSION["valid_user"] == "admin") {
						echo "<center><a href=\"?AdminPageID=Students&New=RegisterENF&Student=Delete&id=".$show[id]."\" onclick=\"return confirm('Are you sure to delete this User')\"><img src='../images/icons/ico_delete.gif' border='0' title=\"Delete Record ($show[firstname] $show[middlename] $show[lastname])\"></a></center>";
					}
					else {
