<?
	...
	//check attachment if any
		if($attachment != "")
		{
			...
			$query = "SELECT firstname, photo from staff where id=$id";
			...
			@unlink("../../contents/directory/photos_staff/$show[photo]");
			@copy($attachment,"../../contents/directory/photos_staff/".$Att_File);
			
		
			$strSql	=	"UPDATE staff SET photo = '$Att_File' WHERE id = $id";
