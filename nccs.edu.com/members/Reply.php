...
<form action="?MemberPageID=Send_Message" method="post" enctype="multipart/form-data" name="frm_compose" id="frm_compose">
  ...
  <? 
    ...
    <tr> 
      ...
      <td width="267"><input name="to" type="text" id="to" value="<? echo "$show[from_member]";?>" size="48" maxlength="255" class="text_box"> 
      </td>
    ...
    <tr> 
      ...
      <td colspan="2"><input name="subject" type="text" class="text_box" id="subject" value="Re: <? echo "$show[subject]";?>" size="67" maxlength="255"></td>
    </tr>
    <tr class="EE"> 
