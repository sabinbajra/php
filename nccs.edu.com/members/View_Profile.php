...
//for tbl_students for Semester
	...
	$ss = mysql_fetch_array($rr);
		...
		echo "<br><table width=\"510\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\" class=\"table\">"
			."  <tr>"
		...
		echo"</td>"
			...
			."			<td>";
						if (empty($show[photo])) {
							...
							echo "<img src='../members/mem_photos/".$show[photo]."' alt=\"$show[firstname] $show[middlename] $show[lastname]\" width=90 height=113>";
						}
		...
		echo"		<hr size=1 color=\"#EEEFF9\"><table width=\"100\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\" class=\"text\">"
			...
			."			<td>";
						...
						if ($show[hide_personal_details]==1) { 
							echo "<img src=\"../images/icons/pin_blue.gif\" width=\"4\" height=\"4\" align=\"absmiddle\"> : Hidden to other members.<hr size=1 color=\"#EEEFF9\"><img src=\"../images/icons/postdate.gif\" width=\"14\" height=\"10\" alt=\"Unhide my Personal Details\" align=\"absmiddle\">&nbsp;<a href=\"member.php?MemberPageID=Option&Opt=ENF&Details=UnHide\" class=\"small_lk\">Unhide details</a>";
						} else { 
							echo "<img src=\"../images/icons/postdate.gif\" width=\"14\" height=\"10\" alt=\"Hide my Personal Details\" align=\"absmiddle\">&nbsp;<a href=\"member.php?MemberPageID=Option&Opt=ENF&Details=Hide\" class=\"small_lk\">Hide details...</a>";
						}
		...
		echo "    </td>"
			...
			if ($show[hide_personal_details]==1) {
				if($show[username] == $_SESSION["valid_user"]) {
					echo"<img src=\"../images/icons/pin_blue.gif\" width=\"4\" height=\"4\" align=\"absmiddle\"> <a href=\"mailto:$show[email]\">$show[email]</a>";
				}
				else {
					echo "Hidden";
				}
...
//-------------------------------------------------------------
		...
		echo "    </td>"
			...
			if (empty($show[phone1])) { 
				...
				if ($show[hide_personal_details]==1) {
					if($show[username] == $_SESSION["valid_user"]) {
						echo"<img src=\"../images/icons/pin_blue.gif\" width=\"4\" height=\"4\" align=\"absmiddle\"> $show[phone1]";
					}
					else {
						echo "Hidden";
					}
		...
		echo "    </td>"
			...
			if (empty($show[phone2])) { 
				...
				if ($show[hide_personal_details]==1) {
					if($show[username] == $_SESSION["valid_user"]) {
						echo"<img src=\"../images/icons/pin_blue.gif\" width=\"4\" height=\"4\" align=\"absmiddle\"> $show[phone2]";
					}
					else {
						echo "Hidden";
					}
		...
		echo "    </td>"
			...
			if (empty($show[mobile])) { 
				...
				if ($show[hide_personal_details]==1) {
					if($show[username] == $_SESSION["valid_user"]) {
						echo"<img src=\"../images/icons/pin_blue.gif\" width=\"4\" height=\"4\" align=\"absmiddle\"> $show[mobile]";
					}
					else {
						echo "Hidden";
					}
		...
		echo "    </td>"
			...
			if ($show[hide_personal_details]==1) {
				if($show[username] == $_SESSION["valid_user"]) {
					echo"<img src=\"../images/icons/pin_blue.gif\" width=\"4\" height=\"4\" align=\"absmiddle\"> $show[address1]";
				}
				else {
					echo "Hidden";
				}
		...
		echo"  </tr>"
			...
			if (empty($show[address2])) { 
				...
				if ($show[hide_personal_details]==1) {
					if($show[username] == $_SESSION["valid_user"]) {
						echo"<img src=\"../images/icons/pin_blue.gif\" width=\"4\" height=\"4\" align=\"absmiddle\"> $show[address2]";
					}
					else {
						echo "Hidden";
					}
