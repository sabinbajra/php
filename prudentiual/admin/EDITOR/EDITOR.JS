...
this.btnList = {
    ...
    "about":          ['about',                'About Editor',  'editor_about(\''+objname+'\')',  'ed_about.gif'],
...
function editor_about(objname) {
  showModalDialog(_editor_url + "popups/about.html", window, "resizable: no; help: no; status: no; scroll: no; ");
}
